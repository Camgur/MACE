...
base = '/home/cgurwell/scratch/asemd/' + filename.replace('.cif', '').replace('opt_', '') + '/mace/'
...
calculator = MACECalculator(model_paths='/home/cgurwell/projects/rrg-ravh011/cgurwell/opt/mace-mp-0b3-medium.model',
                            dispersion=False, device='cuda', default_dtype='float32')
