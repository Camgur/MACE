...
for structure, string in zip(compiled, strings):
    ...
    analyse = analysis.Analysis(exp, build_neighbor_list(exp))
    analyse2 = analysis.Analysis(structure, build_neighbor_list(structure))
    bonds = analyse.get_bonds('Zr', 'O', unique=True)
    bonds2 = analyse2.get_bonds('Zr', 'O', unique=True)
...
for structure, string in zip(compiled, strings):
    ...
    analyse = analysis.Analysis(exp, build_neighbor_list(exp))
    analyse2 = analysis.Analysis(structure, build_neighbor_list(structure))
    bonds = analyse.get_bonds('P', 'O', unique=True)
    bonds2 = analyse2.get_bonds('P', 'O', unique=True)
...
df.to_excel('MACE/optimise/LZPO_91112/li-o_distances.xlsx', index=True)

df = pd.DataFrame(compilation2, index=strings)
df.to_excel('MACE/optimise/LZPO_91112/zr-o_distances.xlsx', index=True)

df = pd.DataFrame(compilation3, index=strings)
df.to_excel('MACE/optimise/LZPO_91112/p-o_distances.xlsx', index=True)
'''
...
df.to_excel('MACE/optimise/LZPO_91112/dftli-o_distances.xlsx', index=True)

df = pd.DataFrame(compilation2, index=strings[:5])
df.to_excel('MACE/optimise/LZPO_91112/dftzr-o_distances.xlsx', index=True)

df = pd.DataFrame(compilation3, index=strings[:5])
df.to_excel('MACE/optimise/LZPO_91112/dftp-o_distances.xlsx', index=True)
